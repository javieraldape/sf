...
test-compiled-e2e:
	go test -count=1 -shuffle=off -p 1 -timeout 30m -tags sf_e2e ./cmd/sf -run '^(TestCompiledDev(GuardedWalkingSkeleton|ManualWalkingSkeleton|FriendlyOperatorTakeover)|TestCompiledStableAndDevDaemonsCoexist|TestCompiledCleanStateReadinessRefusalsAndOfflineStacks)$$'
