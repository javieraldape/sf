...
func TestPostbuildAmendmentCandidateFinalizationRecovery(t *testing.T) {
	testPostbuildCandidateFinalizationRecovery(t, true, false, false)
}

func TestPostbuildAmendmentCandidateFinalizationRecoveryAfterRestart(t *testing.T) {
	testPostbuildCandidateFinalizationRecovery(t, true, false, true)
}

func TestPostbuildAmendmentRecordedCandidateFinalizationRecovery(t *testing.T) {
	testPostbuildCandidateFinalizationRecovery(t, true, true, false)
}

func TestPostbuildAmendmentRecordedCandidateFinalizationRecoveryAfterRestart(t *testing.T) {
	testPostbuildCandidateFinalizationRecovery(t, true, true, true)
}
	...
	for _, recorded := range []bool{false, true} {
		for _, restart := range []bool{false, true} {
			t.Run(fmt.Sprintf("recorded_%t/restart_%t", recorded, restart), func(t *testing.T) {
				testPostbuildCandidateFinalizationRecovery(t, false, recorded, restart)
			})
		}
	}
}

func testPostbuildCandidateFinalizationRecovery(t *testing.T, amendment, recorded, restart bool) {
